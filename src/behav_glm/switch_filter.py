...
def id_bad_trials(trial_wts: List[np.ndarray], fs=60, nperseg=1024) -> List[bool]:
...
def filter_crossings(cross_idcs, n_timestamps, start_drop_thresh=20, end_drop_thresh=11, diff_thresh=3):
    filtered_idcs = []
    for cross_idx in cross_idcs:
